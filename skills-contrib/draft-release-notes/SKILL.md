...
- User-facing migrations: `https://github.com/prisma/prisma/blob/v$NEXT/skills/prisma-orm-core-concepts/upgrading/app/upgrades/<prev.minor>-to-<head.minor>/`
- Extension-author migrations: `https://github.com/prisma/prisma/blob/v$NEXT/skills/prisma-orm-core-concepts/upgrading/extension/upgrades/<prev.minor>-to-<head.minor>/`
