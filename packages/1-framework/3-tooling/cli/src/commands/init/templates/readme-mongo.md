...
- `{{runDev}}` — run the Prisma 8 sample script
...
Prisma 8 setup is scaffolded in:
...
For provider-specific Prisma 8 reference docs, see `prisma-next.md`. Prisma 8 skills live in the upstream `skills/` directory: https://github.com/prisma/prisma/tree/main/skills.

Node-based Prisma 8 projects expect Node.js 24 LTS or newer.
